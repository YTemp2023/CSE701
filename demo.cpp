 ...
 * @file demo.cpp
 * @author Yiding Li
 * @brief An demonstration of the Int class (in bigint.hpp).
 * @version 0.1
 * @date 2024-01-01
 */
#include "bigint.hpp"
...
int main()
{
    ...
    bigint::Int int_b("9999999999999999999999999999999999999999999999999999999999999999999999999");
    ...
    bigint::Int int_c("99999999");
    bigint::Int int_d("-900009");
    ...
    //
    bigint::Int int_c_large("8000000000000000000000000000000000000000000000000000000");
    bigint::Int int_d_large("-450000000045454500000000000000000");
    bigint::Int c_plus_d = int_c_large + int_d_large;
