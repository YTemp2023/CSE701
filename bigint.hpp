 ...
 * @file bigint.cpp
 * @author Yiding Li
 *  An implementation of arbitrary-length integers.
 * @version 0.1
 * @date 2023-12-28
 */
...
namespace
{
    ...
    /**
     *  Convert a integer to a single digit.
     *
    ...
    /**
     *  Raise 2 to the power of a large base, then return the value. Fails if the result cannot be represented.
     *
    ...
    /**
     *  Sum two strings of digits, then return the result.
     *
    ...
    /**
     *  Convert a vector of bools (0s and 1s) to a string of decimal digits.
     *
     * @param a_bools
     * @return double
    ...
    /**
     *  Check of the divisor can divide the divident, if their least significant
    ...
    /**
     *  Given two vectors of boolean values, check if the first one is bigger than the second.
    ...
    /**
     *  Subtract two boolean vectors. Subtract the smaller one from the larger one, then return the result.
     *
    ...
    /**
     *  Check if a bool vector contains only "zero"s.
     *
    ...
    /**
     *  Auxillary function. Divide two values then return the result, as well as the remainder, through its arguments
     *
     * @param a_dvd The dividend
     * @param a_dvs The divisor
    ...
    /**
     *  Shift the given bool vector by 1 to the left
     *
    ...
    /**
     *  Add two bool vectors, then return the result.
    ...
    /**
     *  Multiply two bool vectors, then return the result.
     *
...
namespace bigint
{
    ...
    /**
     *  Arbitrary-length integer. Its length is technically limited to the smaller of int64_t and size_t, though this limitation is unlikely to come up.
     */
    class Int
    {
    public:
        ...
        friend string to_string(const bigint::Int &a_int);
        Int operator-() const;
    ...
    /**
     * Return a binary string representaiton of this instance.
     *
     * @return A binary string that represents the value contained in this instance.
     */
    string Int::to_str_bools() const
    {
        if (is_zero_vector(this->bools))
            return "0";
        string result;
        bool is_1_met = false;
    ...
    /**
     * Return a decimal string representation of this integer.
     *
     * @return A decimal string that represents the value contained in this instnace.
     */
    ...
    /**
     * Constructor from a string of decimal digits.
     *
     * @param a_in The input string.
    ...
    /**
     * Constructor from attributes. The assignment operator of vector copies, meaning that the result is distinct.
     *
    ...
    /**
     * Take a string, analyze it, then load the result into the bools field of this object.
     *
    ...
    /**
     * Insert an Int to a output stream.
     * @param a_os An output stream.
     * @param a_int An instance of Int to be inserted to the stream.
    ...
    /**
     * Create a copy of the rvalue, then assign it to this instance.
     * @param a_opr_2 An instance of Int to assign to this instance.
    ...
    /**
     * Add this instance to the given value, then return a copy of the result.
     * @param a_that An instance of Int to add to this instance.
    ...
    /**
     * Modify this instance to be the result of the addition this + a_that.
     * @param a_that An instance of Int to add to this instance.
     */
    ...
    /**
     * Subtract the given value from this instnace, then return a copy of the result.
     * @param a_that An instance of Int to subtract from this instance.
    ...
    /**
     * Modify this instance to be the result of the subtraction this - a_that.
     * @param a_that An instance of Int to subtract from this instance.
     */
    void Int::operator-=(const Int &a_that)
    {
    ...
    /**
     * Multiply this instance with the given value, then return a copy of the result.
     * @param a_that An instance of Int to multiply with this instance.
    ...
    /**
     * Modify this instance to be the result of the multiplication this * a_that.
     * @param a_that The other multiplier.
     */
    void Int::operator*=(const Int &a_that)
    {
        Int result = Int(*this) * a_that;
    ...
    /**
     * Divide this instance with the given value, then return a copy of the result.
     * @param a_that An instance of Int to add to divide this instance.
     * @return The divisor.
     */
    Int Int::operator/(const Int &a_that) const
    {
    ...
    /**
     * Modify this instance to be the result of the division this / rvalue.
     * @param a_that The divisor.
     */
    void Int::operator/=(const Int &a_that)
    {
        Int result = Int(*this) / a_that;
    ...
    /**
     * Return true if the operands contain identical values. Otherwise, return false.
     * @param a_that An instance of Int to compare against this instance.
     */
    bool Int::operator==(const Int &a_that) const
    {
        if (is_zero_vector(this->bools) && is_zero_vector(a_that.bools))
            return true;
        return this->bools == a_that.bools && this->is_positive == a_that.is_positive;
    }

    /**
     * Return true if the operands contain different values. Otherwise, return false.
     * @param a_that An instance of Int to compare against this instance.
     */
    bool Int::operator!=(const Int &a_that) const
    {
   ...
   /**
     * Return true if the left operand is greater than the right operand. Otherwise, return false.
     * @param a_that An instance of Int to compare against this instance.
     */
    bool Int::operator>(const Int &a_that) const
    {
    ...
    /**
     * Return true if the left operand is less than the right operand. Otherwise, return false.
     * @param a_that An instance of Int to compare against this instance.
     */
    bool Int::operator<(const Int &a_that) const
    {
    ...
    /**
     * Return true if the left operand is greater or equal to the right operand. Otherwise, return false.
     * @param a_that An instance of Int to compare against this instance.
     */
    bool Int::operator>=(const Int &a_that) const
    {
    ...
    /**
     * Return true if the left operand is less or equal to the right operand. Otherwise, return false.
     * @param a_that An instance of Int to compare against this instance.
     */
    bool Int::operator<=(const Int &a_that) const
    {
   ...
   /**
     * Return the negation of a copy of this instance.
     * @return A new instance of Int that represents the negation of this instance.
     */
     ...
     * @return A decimal string that represents the value contained in this instnace.
     */
    string to_string(const bigint::Int &a_int)
    {
        return a_int.to_str();
    };